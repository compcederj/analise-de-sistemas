# Análise de Sistemas
Repositório de provas antigas da Disciplina **Análise de Sistemas** do curso de **Tecnologia em Sistemas de Computaćao** da **UFF** ministrado através do **CEDERJ**.
...
`git clone https://github.com/compcederj/analise-de-sistemas.git`
...
`git clone git@github.com:compcederj/analise-de-sistemas.git`
...
# Análise de Sistemas
Repositório de provas antingas da Disciplina **Análise de Sistemas** do curso de **Tecnologia em Sistemas de Computaçao** da **UFF** ministrado através do **CEDERJ**.
